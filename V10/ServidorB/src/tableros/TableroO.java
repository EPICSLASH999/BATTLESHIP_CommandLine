...
public class TableroO {
    ...
    public String Tiro(String coord){
        // Método para registrar el Tiro del oponente sobre el propio
        // Y regresa el valor al oponente
        String elTiroFue = "";
        ...
        switch(tiro){
            ...
            case adyacente:
                ...
                break;
            case nave:
                // Si el tiro fue acertado sucede esto
                for(Barco b:barcos){
    ...
    public String construirBarco(Barco b) {
        // Método principal para construir un barco
        
        String e = calcularCasillas(b); // Primero se obtiene si el barco se puede construir
    ...
    public String calcularCasillas(Barco b) {
        // Devuelve el veredicto sobre si el barco se puede o no construir
        // En caso de que no, dice la razon
    ...
    public void construirCasillasBarco(Barco b) {
        // Construye el barco sobre el tablero
    ...
    public void construirCasillasAdyacentes(Barco b) {
        // Método que construye las casillas adyacentes a los barcos para que ahi no se pueda colocar otro barco
        try {
    ...
    public int calcularFila(String coord) {
        // Regresa el valor numerico de la fila a partir de una coordenada
        int c = 0;
    ...
    public int calcularColumna(String coord) {
        // Regresa el valor numerico de la columna a partir de una coordenada
        String n = "";
        if (coord.length() == 3) {
    ...
    public String getTablero() {
        // Devuelve el tablero en una sola cadena de String 
        String espaciado = "  ";
